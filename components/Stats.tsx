...
const achievements = [
  {
    ...
    value: "3000+",
    description: "LeetCode, Codeforces, AtCoder, CSES problems solved by our members",
    icon: Code,
    color: "text-blue-400",
  },
  {
    ...
    value: "1",
    description: "Top 2% performers on LeetCode",
    icon: Star,
  ...
  },
  {
    ...
    value: "2",
    description: "Top 0.5% performers on LeetCode",
    icon: Flame,
    color: "text-red-400",
  },
  {
